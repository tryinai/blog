<!DOCTYPE html>
<!-- saved from url=(0148)file:///Users/fly/Desktop/cross/test/ChengDianFangYi-gh-pages/%E5%B9%B3%E5%AE%89%E6%88%90%E7%94%B5%E6%99%BA%E6%85%A7%E9%80%9A%E8%A1%8C%E5%85%A5.html -->
...
iframe.dictionaries-card.dictionaries-card-minimal {
  ...
  <body data-new-gr-c-s-check-loaded="14.987.0" data-gr-ext-installed="">
    <noscript>
      &lt;strong&gt;We're sorry but mine doesn't work properly without JavaScript enabled. Please enable it to continue.&lt;/strong&gt;
    </noscript>
    <div id="app" style="display: block;">
		<div class="all" data-v-78b386c8="">
			<div class="title" data-v-78b386c8="">
				<p data-v-78b386c8="" id="degree_name">研究生用户，入校授权有效！</p>
			</div>
				<div class="student" data-v-78b386c8="">
					<div class="info" data-v-78b386c8="">
						<span data-v-78b386c8="">
							<img width="11" alt="" src="./平安成电智慧通行_files/yonghu.3c08ded6.png" data-v-78b386c8="">
							用户姓名
						</span>
						<span class="name" id="realname" data-v-78b386c8="">王欣</span>
					</div>
					<div class="info" data-v-78b386c8="">
						<span data-v-78b386c8="">
							<img width="12" alt="" src="./平安成电智慧通行_files/user-group-fill.02d9192d.png" data-v-78b386c8=""> 
							登记类型
						</span>
						<span class="education" id="degree_name2" data-v-78b386c8="">研究生 （博士）</span>
					</div>
					<div class="info" data-v-78b386c8="">
						<span data-v-78b386c8="">
						<img width="20" class="miaobiao" alt="" src="./平安成电智慧通行_files/miaobiao.9497b743.png" data-v-78b386c8="">
						登记时间
						</span>
						<div id="time" data-v-78b386c8="">
						<span id="time1" style="left: -68px;" data-v-78b386c8="">2022-3-1 10:31:52</span>
						<span id="time2" style="left: 132px;" data-v-78b386c8="">2022-3-1 10:31:52</span>
						</div>
					</div>
					
          <div align="center">
            <img src="./平安成电智慧通行_files/xiaohui.png" width="40" height="40">
          </div>
				</div>
			</div>
		</div>
    <!-- built files will be auto injected -->
	<div id="name_get" class="all">
		姓名：<input type="text" id="uname" placeholder="请输入你的名字" autocomplete="off" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%;">
		<input type="button" value="确认" onclick="name_in()">
	</div>

  <div id="degree_get" class="all" style="display: none;">
    学历：<input type="text" id="dname" placeholder="输入学历(本科生/研究生)" autocomplete="off" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%;">
    <input type="button" value="确认并跳转" onclick="degree_in()">
  </div>
...
function name_in(){
	...
	name.innerHTML = text;
	// name_get.style.display = "none";
	// app.style.display = "block";
	
}

function degree_in(){
  var utext = document.getElementById("dname");
  var text = utext.value;
  var name = document.getElementById("degree_name");
  var name2 = document.getElementById("degree_name2")
  var app = document.getElementById("app");
  var name_get =document.getElementById("degree_get");
  name.innerHTML = text+"用户,入校登记成功";
...
</div><script type="text/javascript" id="webrtc-control">(function () {
